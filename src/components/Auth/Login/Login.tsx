...
import { Asterisk, Warning, QsInput, QsInputPassword } from '../../Generals/DataEntry';
...
export const Login = () => {
    ...
    // OnChange Login Form
    const [username, setUserName] = useState('user02') // user01 - user02 - user03
    const [password, setPassWord] = useState('Pa$$w0rd') // same password
