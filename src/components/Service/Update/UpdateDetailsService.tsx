...
import { ContentSpace, ContentTitle } from "../../Layout/Content";
import { QSCard } from "../../Generals/DataDisplay";
import { QSTypography } from "../../Generals/Typography";
import { Asterisk, QsInput, QsTextArea, QsCheckbox } from "../../Generals/DataEntry";
import { QsButton } from "../../Generals/Button";
                ...
                <Form layout='vertical' className='form-control'>
                    <Row gutter={[24,0]}>
                        <Col xs={24} lg={12} xl={12}>
                            ...
                            >
                                <QsInput placeholder='Nhập mã dịch vụ' value={service.id} />
                            </Form.Item>
                            ...
                            <Form.Item
                                ...
                                tooltip={{ title: 'This is a required field', icon: Asterisk }}
                            >
                                <QsInput placeholder='Khám tim mạch' value={service.name} />
                            </Form.Item>
                        </Col>
                        <Col xs={24} lg={12} xl={12}>
                            <Form.Item
                                ...
                                label="Mô tả:"
                            >
                                <QsTextArea placeholder="Mô tả dịch vụ" value={service.desc} />
                            </Form.Item>
                        </Col>
                    </Row>
                    <Row gutter={[24, 0]}>
                        <Col xs={24} lg={24} xl={24}>
                            ...
                            <QsCheckbox.Group 
                                defaultValue={service.progression_rules}
                                options={[
